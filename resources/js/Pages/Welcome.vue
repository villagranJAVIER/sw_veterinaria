...
<template>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <template v-else>
                <Link :href="route('login')" class="text-2xl text-gray-500 dark:text-gray-200 underline">Iniciar sesión</Link>

                <Link v-if="canRegister" :href="route('register')" class="ml-4 text-2xl text-gray-500 dark:text-gray-200 underline">Registrarse</Link>
            </template>
        </div>
        ...
        <span class="text-orange-50 text-9xl">
            sasha y llo
        </span>
    </div>
</template>
