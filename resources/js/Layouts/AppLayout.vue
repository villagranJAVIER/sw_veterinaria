...
<template>
    <div>
        ...
        <Head :title="title">
            ...
            <link rel="shortcut icon" sizes="192x192" href="storage/img/logo.png">
        </Head>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="border-b border-gray-100 shadow" style="background-color: #3DC1A8;">
                    ...
                    <div class="flex justify-between h-18">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                ...
                                <ApplicationMark class="block h-28 mt-6 w-auto" />
                                </Link>
                            </div>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-xl leading-4 font-medium rounded-md text-gray-500 bg-transparent hover:text-gray-700 focus:outline-none focus:bg-cyan-200 active:bg-cyan-50 transition">
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }" class="sm:hidden">
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('reservaciones.index')" :active="route().current('reservaciones.index')">
                            Citas
                        </ResponsiveNavLink>
                    </div>
